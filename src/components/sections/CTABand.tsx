          ...
          <div className="relative overflow-hidden rounded-[2rem] md:rounded-[2.5rem] bg-espresso px-7 py-12 md:p-14 text-center shadow-warm-lg">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <a href={`mailto:${SITE.email}`} className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-white/10 text-cream font-heading font-semibold text-base border border-white/20 hover:bg-white/20 transition-all"><Mail className="h-5 w-5" />Email Us</a>
              </div>
            </div>
          </div>
        </FadeIn>

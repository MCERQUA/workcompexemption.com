    ...
    <>
      ...
      <main className="relative bg-warm-radial pt-32 pb-24 md:pt-40 md:pb-32 min-h-[70vh] flex items-center">
        <div className="container-tight text-center">
          ...
          <h1 className="mt-4 font-heading font-extrabold text-espresso text-3xl md:text-4xl tracking-tight">This page isn't on file.</h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href={`mailto:${SITE.email}`} className="btn-ghost"><Mail className="h-5 w-5" />Email Us</a>
          </div>
        </div>
      </main>
      <Footer />

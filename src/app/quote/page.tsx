              ...
              <div className="space-y-4">
                ...
                <FadeIn>
                  <div className="p-5 rounded-2xl bg-espresso text-cream text-center">
                    ...
                    <a href={`mailto:${SITE.email}`} className="flex items-center justify-center gap-2 text-cream font-heading font-extrabold text-xl hover:text-gold-light transition-colors"><Mail className="h-5 w-5" />Email Us</a>
                ...
                {submitted ? (
                  <FadeIn>
                    <div className="p-10 md:p-12 rounded-3xl bg-white border border-adobe shadow-card text-center">
                      ...
                      <p className="text-sm text-mocha">Need it sooner? Call <a href={`mailto:${SITE.email}`} className="text-clay font-heading font-semibold"><Mail className="h-5 w-5" />Email Us</a>.</p>

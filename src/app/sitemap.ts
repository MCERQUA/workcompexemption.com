...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const stateRoutes: MetadataRoute.Sitemap = US_STATES.map((s) => ({ url: `${base}/states/${s.slug}`, lastModified: now, changeFrequency: "monthly", priority: 0.6 }));
  ...
  return [...staticRoutes, ...serviceRoutes, ...locationRoutes, ...stateRoutes, ...postRoutes];
}
